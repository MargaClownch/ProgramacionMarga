...
public class SimuladorNido {
    public static void main(String[] args) {
        ...
        for (int segundo = 1; segundo <= 300; segundo++) {
            ...
            // Envejecer a todas las serpientes 1 año
            ...
            // Limpiar serpientes que hayan muerto de viejas
            ...
            // Nacimientos: Cada 5 segundos nacen entre 1 y 3 serpientes
            if (segundo % 5 == 0) {
            ...
            // Mangosta: Cada 10 segundos aparece
            if (segundo % 10 == 0) {
